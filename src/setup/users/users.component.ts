...
export class UsersComponent implements OnInit {
  displayedColumns: string[] = ['fullName', 'mobileNumber', 'email', 'actions'];
  ...
  ngOnInit(): void {
    this.getAllUsers({
      ...
      pageNumber: 1,
      nameEn: this.getFormControlByName('fullName').value,
...
this.pageIndex = 0;
  ...
  getAllUsers(baseSearch: { pageSize: any; pageNumber: any; nameEn?: string; mobileNumber?: string; address?: string; isActive?: boolean }): void {
    this.spinner.show();
    const Controller = Controllers.User;
